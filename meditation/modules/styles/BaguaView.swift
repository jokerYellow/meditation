...
class BaguaView: UIView {
    ...
    let button :UIButton = {
        ...
        b.layer.cornerRadius = BaguaView.buttonHeight*0.5
    ...
    override init(frame: CGRect) {
        ...
        self.button.snp.makeConstraints { (make) in
            ...
            make.height.equalTo(BaguaView.buttonHeight)
        ...
        self.meditation.addStateCallBack { [weak self](state) in
